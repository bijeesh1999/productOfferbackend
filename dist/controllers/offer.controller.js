...
const createOffer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const offer = yield Offer_model_1.default.create(req.body);
    res.json(offer);
});
exports.createOffer = createOffer;
const findAllOffer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const offer = yield Offer_model_1.default.find({ isActive: true });
    res.json(offer);
});
